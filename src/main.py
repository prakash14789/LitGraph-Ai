...
# POLISH-002: rate limiting (docs/03_SECURITY_ACCESS.md §5.1). Per-route
# limits are declared with @limiter.limit(...) on the routes themselves;
# default_limits (see src/api/rate_limit.py) covers every undecorated route.
